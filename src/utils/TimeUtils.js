...
class TimeUtils {
     ...
     */
    constructor(startTime, endTime = 0, format = "year", offsetDays = 0) {
        ...
        // console.log('timeutil endtime:' + this.endTime.format("YYYY-MM-DD"));
        this.format = format;
        switch (this.format) {
            case _AgeFormat:
                this.yearMark = "岁"
